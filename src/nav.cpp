...
// Flags
int state = 0; // 0: Startup, 1: Target seeking, 2: Returning

// Prototypes
void visionCallback(const robot::Commands::ConstPtr& msg) {
...
int main(int argc, char **argv) {
  ...
  // Publish a topic "Commands" of the "Commands" msg variety, with a message queue of 1000
  ros::Publisher command_pub = n.advertise<robot::Commands>("Commands", 1000);
  
  ros::Subscriber vision_msg = n.subscribe("Vision", 1000, vision_callback);
